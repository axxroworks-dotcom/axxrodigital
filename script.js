...
(function() {
    ...
    setInterval(function() {
        if (
            ...
            if (!devToolsOpen) {
                devToolsOpen = true;
                document.body.innerHTML = '<div style="display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;background:#000;color:#00d2ff;font-family:Michroma,sans-serif;font-size:1.2rem;letter-spacing:2px;text-align:center;padding:20px;">ACCESS RESTRICTED<br><span style="font-size:0.7rem;color:rgba(255,255,255,0.4);margin-top:10px;display:block;letter-spacing:3px;">AXXRO DIGITAL — PROTECTED SYSTEM</span></div>';
            }
        } else {
            devToolsOpen = false;
        }
